...
- (void)createDialogWithTitle:(NSString *)title content:(NSString *)content
{
    ...
    UIImage *image = [UIImage imageNamed:@"dll_dialog_cancel_normal.png"];
    ...
    image = [UIImage imageNamed:@"dll_dialog_cancel_highlight.png"];
    ...
    image = [UIImage imageNamed:@"dll_dialog_know_highlight.png"];
